...
public class Utils {
    ...
    public static void sendDeleteMessageToBackUpNode(int snId){
        ...
        ChannelFuture cf = NetUtils.getInstance(Constants.CONTROLLER).connect(bootstrap, backupSn.getSnIp(),
                backupSn.getSnPort());
        StorageMessages.DeleteBackUp.Builder deleteBackUpBuilder = StorageMessages.DeleteBackUp.newBuilder();
